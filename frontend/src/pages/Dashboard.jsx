    ...
    <div className="relative min-h-screen text-gray-900 dark:text-white bg-gradient-to-br from-slate-100 to-blue-200 dark:from-[#0f172a] dark:to-[#1e293b]">
      ...
      <main className="p-6 space-y-10">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Here's an overview of your Excel analytics</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Import new data for analysis</p>
          </div>
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow text-center border-l-4 border-green-500">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Charts Created</p>
          </div>
        ...
        <div className="overflow-x-auto bg-white dark:bg-slate-800 rounded-xl shadow">
          <h3 className="text-xl font-bold p-4 border-b border-gray-200 dark:border-slate-700">📁 Recent Files</h3>
              ...
              {uploads.length > 0 ? (
                uploads.map((upload) => (
                  <tr key={upload._id} className="border-b dark:border-slate-700">
                    ...
                    <td className="py-3 px-6">{new Date(upload.createdAt).toLocaleDateString()}</td>
                    <td className="py-3 px-6">{upload.size || "—"}</td>
                    <td className="py-3 px-6 space-x-3">
                      <button className="text-blue-600 hover:underline">Analyze</button>
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">No charts rendered yet.</p>
